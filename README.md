...
1. lanciamo da terminale: php artisan make:model Models/Pasta -msr

## creazione model, controller normale, migration, seeder con shortcut
1. lanciamo da terminale: php artisan make:model Models/Pasta -msc

## creazione controller risorsa
1. lanciamo da terminale: php artisan make:controller PastaController --resource

## scrittura in web.php di un controller risorsa
1. scriviamo in web.php:
Route::resource('/pastas', PastaController::class);

2. Per controllare che le rotte del controller risorsa sono state correttamente create lanciamo il comando :
